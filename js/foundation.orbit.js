  ...
  var Orbit = function(el, settings) {
    ...
    self.build_markup = function() {
      ...
      if (settings.navigation_arrows) {
        ...
        //container.append($('<a href="#"><img src="images/icons/foundation5slideprev.gif" style="z-index: 99999;"></a>').addClass(settings.prev_class));
        //container.append($('<a href="#"><img src="images/icons/foundation5slidenext.gif" style="z-index: 99999;"></a>').addClass(settings.next_class));
      }
